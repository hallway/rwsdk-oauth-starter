/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 69a0272df39e91c269abdda4014e63da)
// Runtime types generated with workerd@1.20250525.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WEBAUTHN_APP_NAME: "rwsdk-oauth-starter";
		ENVIRONMENT: string;
		RP_ID: string;
		SECRET_KEY: string;
		...
		AUTH_SECRET: string;
		DATABASE_URL: string;
		ESM_BUILD_SERVER: string;
		HALLWAY_BUILD_SERVER: string;
		HALLWAY_NODE_SERVER_HOSTNAME: string;
		HALLWAY_NODE_SERVER_PROTOCOL: string;
